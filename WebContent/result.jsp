...
%>
    <jsp:forward page="user_Servlet">
         <jsp:param name="web" value="result.jsp"></jsp:param>
    </jsp:forward> 
<% }else{ 
%>
 	...
 	<div id="main">
 		...
 		<% if(request.getAttribute("search_Bean")!=null){ %>
 		 ...
 		 <% book=search_Bean.getTableRecord();
 			num=search_Bean.getBookNumber();
 			 } %>
 			<% for(int i=0;i<num;i++){ %>
 		<div class="detail">
 		<div class="tiltle"> </div>
 		<div class="book">
 		<% String booki8=book[i][8]; %>
 		<a href="introduce.jsp"><img src="<%=booki8 %>" ></a>
 		<form action="user_Servlet" method="post">
 		<input type="submit" name="author" value="<%=book[i][1]%>">
 		</form>
