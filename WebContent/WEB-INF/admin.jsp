...
<body style="background-color: #f9f9f9">
	...
	<table width="700" border="1" style="margin: 10px auto;">
		<tr>
		<td width="100" height="280"><a href="javascript:funcShow(1)" style=" text-decoration: none;color:#2F4F4F">上传书籍信息 </a></td>
		...
		<tr>
		<td height="280"><a href="javascript:funcShow(2)" style="text-decoration: none;color: #2F4F4F">修改书籍信息</a></td>
		</tr>
		</tr>
	</table>	
